...
const links = [
  { href: "/sistema/recetario", label: "Recetario", icon: BookOpen, description: "Fórmulas y elaboración de cada producto" },
...
const adminLinks = [
  { href: "/sistema/configuracion/usuarios", label: "Usuarios", icon: UserCog, description: "Crear y administrar accesos" },
];
